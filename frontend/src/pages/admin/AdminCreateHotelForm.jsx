                ...
                >
                  ...
                  <section className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                      <div className="space-y-2">
                        ...
                        <input
                          ...
                          className={`w-full rounded-md border px-3 py-2 shadow-sm focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500 ${errors.nombre ? 'border-red-500' : 'border-gray-300'
                      ...
                      <div className="space-y-2">
                        ...
                        <input
                          ...
                          className={`w-full rounded-md border px-3 py-2 shadow-sm focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500 ${errors.telefono ? 'border-red-500' : 'border-gray-300'
                            } ${loading || isSubmitting ? 'cursor-not-allowed bg-gray-100' : ''}`}
                        />
                        {errors.telefono && (
                          <p className="text-sm text-red-500">
                    ...
                    <div className="space-y-2">
                      ...
                      <input
                        ...
                        className={`w-full rounded-md border px-3 py-2 shadow-sm focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500 ${errors.direccion ? 'border-red-500' : 'border-gray-300'
                          } ${loading || isSubmitting ? 'cursor-not-allowed bg-gray-100' : ''}`}
                      />
                      {errors.direccion && (
                        <p className="text-sm text-red-500">
                    ...
                    <div className="space-y-2">
                      ...
                      <input
                        ...
                        className={`w-full rounded-md border px-3 py-2 shadow-sm focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500 ${errors.email ? 'border-red-500' : 'border-gray-300'
                          } ${loading || isSubmitting ? 'cursor-not-allowed bg-gray-100' : ''}`}
                      />
                      {errors.email && (
                        <p className="text-sm text-red-500">
                  ...
                  <section className="space-y-2">
                    ...
                    <select
                      ...
                      disabled={loading || isSubmitting}
                      className={`w-full rounded-md border px-3 py-2 shadow-sm focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500 ${errors.categoriaId ? 'border-red-500' : 'border-gray-300'
                        } ${loading || isSubmitting ? 'cursor-not-allowed bg-gray-100' : ''}`}
                    >
                      <option value="">
                        {loading
                  ...
                  <div className="flex gap-3 border-t pt-6">
                    <button
                      ...
                      className={`flex-1 rounded-md border border-gray-300 bg-white px-4 py-2 text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 ${loading || isSubmitting
                    ...
                    <button
                      type="submit"
                      disabled={loading || isSubmitting}
                      className={`flex-1 rounded-md bg-gradient-to-r from-blue-600 to-indigo-600 px-4 py-2 text-white hover:from-blue-700 hover:to-indigo-700 focus:outline-none focus:ring-2 focus:ring-blue-500 ${loading || isSubmitting
                          ? 'cursor-not-allowed opacity-50'
                          : ''
                        }`}
                    >
