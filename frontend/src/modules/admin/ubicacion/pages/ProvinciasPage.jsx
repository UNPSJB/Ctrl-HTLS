...
import { Map, Pencil, Trash2, ChevronRight, ArrowLeft, AlertTriangle } from 'lucide-react';
...
function ProvinciasPage() {
  ...
  // Nombre del país para mostrar en el header
  ...
  return (
    <div className="h-full flex flex-col gap-6 overflow-hidden">
      ...
      {/* Botón volver al header area */}
      <div className="flex-shrink-0">
        <button
          onClick={() => navigate('/admin/ubicacion/paises')}
        ...
        <ListHeader
          ...
          description={`Administra las provincias que pertenecen a ${nombrePais}`}
                      ...
                      <tr key={provincia.id} className="group transition-colors hover:bg-gray-50/60 dark:hover:bg-gray-700/20">
                        ...
                        <td className="px-6 py-3 w-[32%]">
                          <div className="flex items-center justify-end gap-1">
                            ...
                            <button
                              onClick={() => navigate(`/admin/ubicacion/provincias/${provincia.id}/ciudades`)}
