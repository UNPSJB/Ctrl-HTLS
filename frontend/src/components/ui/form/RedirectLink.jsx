 ...
 * 
 * @param {string} to - Ruta de destino. (Opcional si se usa onClick).
 * @param {function} onClick - Función a ejecutar en lugar de navegar. (Opcional si se usa to).
 ...
 */
const RedirectLink = ({ to, onClick, text, label, className = '', newTab = false, disabled = false }) => {
  return (
